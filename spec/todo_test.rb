...
class TodoTest < MiniTest::Test
  ...
  def test_view_todos_prints_unfinished_header
    ...
    #That somewhere in the view_todos method we said `puts "Unfinished"`
  end
  ...
  def test_change_todo_name
    todo_setup # Given
    $input.push("change todo test")
    @todo.change_todo_name
    assert_equal("change todo test,no\n", @todo.todos[0].to_s)
  end
